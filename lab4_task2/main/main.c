...
static const char *TAG = "lab4_task2";

char *TARGET_HOST = "www.duke.edu";
...
void app_main() {
  ...
  if (do_ping_cmd(TARGET_HOST, 1000) == 0) {
    ESP_LOGI(TAG, "do_ping_cmd success");
  } else {
    ESP_LOGE(TAG, "do_ping_cmd fail");
  }
}
